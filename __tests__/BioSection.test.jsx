...
import { DEFAULT_USER_NAME, DEFAULT_BIO, DEFAULT_AVATAR, DEFAULT_USER } from "@/app/lib/constants";
...
describe("BioSection", () => {
  ...
  it("applies the correct CSS classes", () => {
    render(<BioSection user={DEFAULT_USER} />);
    const bioSection = screen.getByText(/Bio text goes here/).closest(".bio-section");
    expect(bioSection).toHaveClass("bio-section");
    const headerSection = screen.getByText("Demo User").closest(".bio-header-section");

    ...
    <div id="edit-bio">
      ...
      <div id="form-area" className="text-box">
        <form onSubmit={handleSubmit}>
          ...
          <input
            className="text-sm file:mr-5 file:py-1 file:px-3 file:border-[1px] file:text-xs file:font-medium file:bg-stone-50 file:text-stone-700 hover:file:cursor-pointer hover:file:bg-green-300 hover:file:text-green-800"
            type="file"
            accept="image/*"
            name="avatar"
            id="newAvatar"
